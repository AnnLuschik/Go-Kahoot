    ...
    <div className={classes.root}>
      ...
      >
        ...
        <ExpansionPanelDetails className={classes.content}>
          ...
          />
          <Typography>
            <b>If you need to create other question.</b> Click "Yes" button. For
            example:
          </Typography>
          <img
          ...
          />
          <Typography>
            <b>If you don't need to create other question.</b> Click "No" button
            and you will see:
          </Typography>
          <img
          ...
          />
          <Typography>
            All fields cannot have less than 4 characters, please consider this.
          </Typography>
      ...
      >
        ...
        <ExpansionPanelDetails className={classes.content}>
          ...
          <img src={editTestImage} className={classes.image} alt="Edit Test" />
      ...
      >
        ...
        <ExpansionPanelDetails className={classes.content}>
          ...
          <Typography>
            ...
            After that you can see list of already activating tests. If you want
            to join, you will need find the button by name "Join toward active
            test". Click to here and choose your name.
          </Typography>
          <img src={joinTestImage} className={classes.image} alt="Join Test" />
      ...
      >
        ...
        <ExpansionPanelDetails className={classes.content}>
          <Typography>
            ...
            start the game, when you wait for all your friends, click the "Start
            button".
          </Typography>
          <img
      ...
      >
        ...
        <ExpansionPanelDetails className={classes.content}>
          <Typography>
            ...
            have time to answer the question, it will not be protected. You can
            see whether your answer is correct or not by highlighting the button
            pressed: if it is red, you answered incorrectly. If green - you
            guessed it, well done.
          </Typography>
          <img
